...
class Client(models.Model):
    ...
    owner = models.ForeignKey(
        Account, on_delete=models.CASCADE, verbose_name="Client Owner"
    )
    ...
    address = models.CharField(
        max_length=200, blank=True, verbose_name="Client Address"
    )
    company = models.CharField(
        max_length=150, blank=True, verbose_name="Client Company"
    )
...
class Project(models.Model):
    ...
    users = models.ManyToManyField(
        Account, null=True, related_name="project_clients", verbose_name="Project Users"
    )
    name = models.CharField(max_length=100, blank=False, verbose_name="Project Name")
    description = models.CharField(
        max_length=1000, blank=True, verbose_name="Project Description"
    )
...
class ProjectInvite(models.Model):
    ...
    email = models.CharField(
        max_length=150, blank=False, null=False, verbose_name="Invite Email"
    )
    created_at = models.DateTimeField(auto_now=True, verbose_name="Created At")
    expire_at = models.DateTimeField(
        default=datetime.now() + timedelta(days=10), verbose_name="Created At"
    )
...
class ProjectPosts(models.Model):
    TYPE_CHOICES = (("BUG", "Bug"), ("QUESTION", "Question"), ("NOTE", "Note"))
    ...
    content = models.TextField(
        max_length=1000, blank=False, verbose_name="Post Content"
    )
    type = models.CharField(
        choices=TYPE_CHOICES, blank=False, max_length=20, verbose_name="Post Type"
    )
    created_at = models.DateTimeField(auto_now=True, verbose_name="Created At")
...
class Invoice(models.Model):
    ...
    owner = models.ForeignKey(
        Account, on_delete=models.CASCADE, related_name="invoices", verbose_name="Owner"
    )
    name_surname = models.CharField(
        max_length=100, blank=False, verbose_name="Name and Surname"
    )
    ...
    company_name = models.CharField(
        max_length=100, blank=True, verbose_name="Company Name"
    )
    ...
    created_at = models.DateTimeField(
        auto_now=True, blank=True, verbose_name="Created At"
    )
...
class Resume(models.Model):
    ...
    owner = models.OneToOneField(
        Account, related_name="user_resume", on_delete=models.CASCADE
    )
    name = models.CharField(
        max_length=150, default="", blank=True, verbose_name="Name and Surname"
    )
    position = models.CharField(
        max_length=250, default="", blank=True, verbose_name="Position"
    )
    ...
    work_experience = JSONField(
        default=dict(), blank=True, verbose_name="Work Experience"
    )
    ...
    personal_projects = JSONField(
        default=dict(), blank=True, verbose_name="Personal Projects"
    )
    contact_info = JSONField(default=dict(), blank=True, verbose_name="Contact Info")


class TimelineItemClient(models.Model):
    ITEM_IMPORTANCE = (("HIGH", "High"), ("MEDIUM", "Medium"), ("LOW", "Low"))
