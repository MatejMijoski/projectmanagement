...
urlpatterns = [
    ...
    path(
        "clients/<str:client_id>/timeline/", views.TimelineItemListCreateView.as_view()
    ),
    ...
    path(
        "projects/<str:project_id>/posts/", views.ProjectPostsListCreateView.as_view()
    ),
    path(
        "projects/<str:project_id>/posts/<str:id>",
        views.ProjectPostsRetrieveView.as_view(),
    ),
    ...
    path(
        "posts/<str:post_id>/comments/<str:id>",
        views.PostCommentsRetrieveView.as_view(),
    ),
